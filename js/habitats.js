...
async function voirHabitat() {
  ...
  try {
    const response = await fetch("https://arcadia-back-26b810fabe9f.herokuapp.com/api/habitat/get", { method: "GET", headers: myHeaders, mode: "cors" });
...
async function voirAnimal() {
  ...
  try {
    const response = await fetch("https://arcadia-back-26b810fabe9f.herokuapp.com/api/animal/get", { method: "GET", headers: myHeaders, mode: "cors" });
